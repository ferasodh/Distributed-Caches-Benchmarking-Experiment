 ...
 *
 */
public class HazelcastCustomQuery3ComplexDriverBenchmark extends BenchmarkDriverAdapter {
	...
	public boolean test(Map<Object, Object> ctx) throws Exception {
		...
		Collection<Employee> employees = remoteMap.values(new SqlPredicate("age > 50 and name like 'A%' and organization.name like '%tum%'"));
